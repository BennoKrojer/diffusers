...
args.save_dir_captions = f'{args.save_dir_captions}_guidance_scale_{args.guidance_scale}_strength_{args.strength}_steps_{args.num_inference_steps}_{"txt2img_" if args.txt2img else ""}_seed_{args.seed}'
