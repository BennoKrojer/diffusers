...
try:
    ...
    _import_structure["pipeline_stable_diffusion_noisepred"] = ["StableDiffusionNoisePredPipeline"]
...
if TYPE_CHECKING:
    try:
        ...
        from .pipeline_stable_diffusion_inpaint import StableDiffusionNoisePredPipeline
