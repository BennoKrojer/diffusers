...
# CUDA_VISIBLE_DEVICES=7 python3 evaluate_wse.py --task flickr30k_text --batchsize 8 --sampling_steps 10
# CUDA_VISIBLE_DEVICES=7 python3 evaluate_wse.py --task flickr30k_text --batchsize 8 --sampling_steps 10 --lora_dir vanilla_finetuning_lora_savingmodel/checkpoint-4000/
# CUDA_VISIBLE_DEVICES=7 python3 evaluate_wse.py --task winoground --batchsize 8 --sampling_steps 10 --img_retrieval
# CUDA_VISIBLE_DEVICES=7 python3 evaluate_wse.py --task winoground --batchsize 8 --sampling_steps 10 --img_retrieval --lora_dir vanilla_finetuning_lora_savingmodel/checkpoint-4000/
# CUDA_VISIBLE_DEVICES=7 python3 evaluate_wse.py --task vg_relation --batchsize 8 --sampling_steps 10 --subset
# CUDA_VISIBLE_DEVICES=7 python3 evaluate_wse.py --task vg_relation --batchsize 8 --sampling_steps 10 --lora_dir vanilla_finetuning_lora_savingmodel/checkpoint-4000/ --subset
...
# python3 evaluate_wse.py --task flickr30k --batchsize 8 --sampling_steps 250 --subset --cuda_device 7
# python3 evaluate_wse.py --task svo_obj --batchsize 8 --sampling_steps 250 --subset --cuda_device 7
# python3 evaluate_wse.py --task svo_subj --batchsize 8 --sampling_steps 250 --subset --cuda_device 7
# python3 evaluate_wse.py --task svo_verb --batchsize 8 --sampling_steps 250 --subset --cuda_device 7
python3 evaluate_wse.py --task imagecode --batchsize 8 --sampling_steps 250 --cuda_device 7 --subset
python3 evaluate_wse.py --task imagecode_video --batchsize 8 --sampling_steps 250 --subset --cuda_device 7
python3 evaluate_wse.py --task winoground --batchsize 8 --sampling_steps 250 --cuda_device 7