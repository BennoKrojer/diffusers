...
# dataset = VG_Attribution(image_preprocess=None, download=True, root_dir='datasets/vg_attribution')
...
for i, batch in enumerate(dataset):
    ...
    for j, prompt in enumerate(texts):
        ...
        image.save(f"generated_vg_attribution/{i}_{j}_{'finetuned' if LORA else 'zeroshot'}.png")
